...
public partial class AppContext : DbContext
{
    ...
    public virtual DbSet<TitlesStasuse> TitlesStasuses { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TitlesStasuse>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("titles_stasuses_pkey");

            entity.ToTable("titles_stasuses");
            ...
            entity.HasOne(d => d.Anime).WithMany(p => p.TitlesStasuses)
                .HasForeignKey(d => d.IdAnime)
                .HasConstraintName("fk_titles_statuses_to_anime_titles");

            entity.HasOne(d => d.Status).WithMany(p => p.TitlesStasuses)
